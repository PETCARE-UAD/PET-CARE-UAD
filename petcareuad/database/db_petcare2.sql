...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2020 at 04:12 PM
...
--
-- Table structure for table `tb_pemilikhewan`
--
...
--
-- Dumping data for table `tb_pemilikhewan`
--
...
--
-- Table structure for table `tb_penitipan_dan_reservasi`
--
...
--
-- Dumping data for table `tb_penitipan_dan_reservasi`
--
...
--
-- Table structure for table `tb_petcare`
--
...
--
-- Dumping data for table `tb_petcare`
--
...
--
-- Indexes for table `tb_pemilikhewan`
--
...
--
-- Indexes for table `tb_penitipan_dan_reservasi`
--
...
--
-- AUTO_INCREMENT for table `tb_pemilikhewan`
--
ALTER TABLE `tb_pemilikhewan`
...
--
-- AUTO_INCREMENT for table `tb_penitipan_dan_reservasi`
--
ALTER TABLE `tb_penitipan_dan_reservasi`
  MODIFY `id_penitipan_dan_reservasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tb_petcare`
--
ALTER TABLE `tb_petcare`
...
--
-- Constraints for table `tb_penitipan_dan_reservasi`
--
ALTER TABLE `tb_penitipan_dan_reservasi`
